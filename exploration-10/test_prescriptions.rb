...
class RappinTestPrescriptions
	...
	def print_prescriptions()
		header_num = 1
		@prescriptions_database.each do |item| 
	...
	def print_favorites()
		puts "\n Rappin Test Prescription: " + @prescriptions_database[13]
		puts "Kira's Reasoning: I think it is important to keep code as simple as possible. It reduces the complexity and makes it easier to maintain long term and with a team."

		puts "\n Rappin Test Prescription: " + @prescriptions_database[27]
		puts "Kira's Reasoning: After learning about TDD this term, it provided an entirely new perspective to looking at my own code and working on code with teams. Getting code under tests is VALUABLE."

		puts "\n Rappin Test Prescription: " + @prescriptions_database[53]
		puts "Kira's Reasoning: As developers, it is easy to get the itch to 'just write code' but in reality it is importan to remember that it is not necessarily about creating cool new feature after feature. Instead, it is important to identify and understand the code's behavior."
	end
